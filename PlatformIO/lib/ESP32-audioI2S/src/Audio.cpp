...
void Audio::processLocalFile()
{
    ...
    availableBytes = min(availableBytes, static_cast<uint32_t>(InBuff.writeSpace()));
...
void Audio::processWebFile()
{
    ...
    availableBytes = min(static_cast<uint32_t>(InBuff.writeSpace()), static_cast<uint32_t>(availableBytes));
